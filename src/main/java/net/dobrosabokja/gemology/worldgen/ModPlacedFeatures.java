...
public class ModPlacedFeatures {
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> context) {
        ...
        register(
                context,
                GARNET_ORE_PLACED_KEY,
                configuredFeatures.getOrThrow(ModConfiguredFeatures.GARNET_ORE_KEY),
    ...
    private static ResourceKey<PlacedFeature> registerKey(String name) {
        return ResourceKey.create(Registries.PLACED_FEATURE, ResourceLocation.fromNamespaceAndPath(Gemology.MOD_ID, name));
    }
